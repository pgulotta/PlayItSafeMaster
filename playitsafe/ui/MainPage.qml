...
ApplicationWindow {
    ...
    readonly property string categoryBankAccountsColor: "#058328"
    readonly property string categoryAssetColor: "#00b32d"
    readonly property string categoryInvestmentsColor: "#2a5e39"
